...
class ProductViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        min_price = self.request.query_params.get('min_price', None) or self.request.query_params.get('price_gte', None)
        max_price = self.request.query_params.get('max_price', None) or self.request.query_params.get('price_lte', None)
